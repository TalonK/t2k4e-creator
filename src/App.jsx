...
const namesByNationality = {
    american: {
        ...
        last: [
            ...
            "Crosby", "Pope", "Chandler", "O'Neal", "Maynard", "Malone", "Battle", "Puckett", "Starks", "Moody", 
            ...
            "O'Donnell", "Joyner", "Donovan", "Barlow", "Fulton", "Stroud", "Schultz", "Boyle", "Meadows", "Barker", 
            ...
            "Gibbs", "Urban", "Aguirre", "Givens", "Farris", "Gerard", "O'Hara", "Eason", "Gaston", "Moya", 
...
const gameData = {
    ...
    SPECIALTY_DESCRIPTIONS: {
        ...
        "Cryptographer": "+1 modifier to any TECH roll involving breaking or creating encrypted messages and codes.",
        "Diver": "+1 modifier to MOBILITY rolls when swimming, both across the surface and under it. Includes use of SCUBA gear.",
        ...
        "Frontline Leader": "+1 modifier to COMMAND rolls for helping someone who is incapacitated by stress. Does not affect unit morale.",
        ...
        "Interrogator": "+1 modifier to PERSUASION rolls when extracting information from a prisoner.",
        ...
        "Liar": "+1 modifier to any PERSUASION roll when lying to someone.",
        ...
        "Mountaineer": "+1 modifier to MOBILITY rolls for rappelling, ascender-climbing, and knot-tying.",
        "Musician": "+1 modifier to PERSUASION rolls in situations where singing or playing an instrument is helpful. The Referee has final say.",
        ...
        "Paratrooper": "+1 modifier to MOBILITY rolls for skydiving, as well as for reducing damage from falling.",
        ...
        "Psy Ops": "+1 modifier to PERSUASION rolls for changing someone's mind about a particular issue.",
        ...
        "Rider": "+1 modifier to MOBILITY rolls for riding fast and performing maneuvers on horseback. Also negates the negative modifier for shooting from horseback.",
        "Rifleman": "+1 modifier to RANGED COMBAT rolls for firing assault rifles, carbines, submachine guns, and shotguns.",
        "Runner": "+1 modifier to MOBILITY rolls for running.",
        ...
        "Teacher": "+1 modifier to PERSUASION rolls for teaching someone a specialty.",
        "Thief": "+1 modifier to RECON rolls when picking pockets and TECH rolls when picking locks.",
        "Trader": "+1 modifier to PERSUASION rolls when negotiating the price of an item.",
    ...
    CAREERS_DATA: {
        ...
        "swat": { name: "SWAT", type: "civilian", group: "Police", skills: ["Close Combat", "Ranged Combat", "Recon"], specialties: ["Martial Artist", "Rifleman", "Sniper", "Combat Awareness", "Infiltrator", "Scout"], gear: ["Assault rifle or submachine gun", "D6 reloads", "Flak jacket and helmet", "Night vision goggles", "Knife", "Personal medkit"] },
        ...
        "assassin": { name: "Assassin", type: "civilian", group: "Intelligence", skills: ["Close Combat", "Ranged Combat"], specialties: ["Killer", "Interrogator", "Sniper", "Martial Artist", "Improvised Munitions", "Infiltrator"], gear: ["Sniper rifle or suppressed submachine gun", "D6 reloads", "Radio or binoculars", "Knife or explosives", "Personal medkit"] },
        ...
        "sciences": { name: "Sciences", type: "civilian", group: "Education", skills: ["Tech"], specialties: ["Chemist", "Communications", "Computers", "Electrician", "Scientist", "Linguist"], gear: ["Any civilian firearm", "D3 reloads", "Bicycle or 2WD car with half a tank of gasoline"] },
...
const Step3_CareerTerm = memo(({ character, setCharacter, nextStep, setWarBrokeOut }) => {
    ...
    return (
        <>
			...
			<h3 className="text-3xl font-header text-red-500 mb-4">WAR BREAKS OUT</h3>
