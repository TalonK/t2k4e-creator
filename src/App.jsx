...
const gameData = {
    ...
    CAREERS_DATA: {
        ...
        "police_officer": { name: "Police Officer", type: "civilian", group: "Police", skills: ["Close Combat", "Ranged Combat"], specialties: ["Sidearms", "Melee", "Runner", "Racer", "Biker", "Scout"], gear: ["Pistol", "D6 reloads", "Baton (club)", "Patrol car"] },
        "detective": { name: "Detective", type: "civilian", group: "Police", skills: ["Ranged Combat", "Recon", "Persuasion"], specialties: ["Infiltrator", "Interrogator", "Intelligence", "Investigator", "Locksmith", "Linguist"], gear: ["Pistol", "D6 reloads", "Lockpicks", "Personal medkit"] },
        "swat": { name: "SWAT", type: "civilian", group: "Police", skills: ["Close Combat", "Ranged Combat", "Recon"], specialties: ["Martial Artist", "Rifleman", "Sniper", "Combat Awareness", "Infiltrator", "Scout"], gear: ["Assault rifle or submachinegun", "D6 reloads", "Flak jacket and helmet", "Night vision goggles", "Knife"] },
        ...
        "sciences": { name: "Sciences", type: "civilian", group: "Education", skills: ["Tech"], specialties: ["Chemist", "Communication", "Computers", "Electrician", "Scientist", "Linguist"], gear: ["Any civilian firearm", "D3 reloads", "Bicycle or 2WD car", "Pocket calculator"] },
        ...
        "professor": { name: "Professor", type: "civilian", group: "White Collar", skills: ["Persuasion"], specialties: ["Historian", "Chemist", "Scientist", "Linguist", "Psy Ops", "Teacher"], gear: ["Any civilian firearm", "D3 reloads", "2WD car"] },
        "manager": { name: "Manager", type: "civilian", group: "White Collar", skills: ["Tech", "Command", "Persuasion"], specialties: ["Quartermaster", "Computers", "Frontline Leader", "Logistician", "Teacher", "Counselor"], gear: ["Any civilian firearm", "D3 reloads", "2WD car"] }
    },
    CAREER_REQUIREMENTS: {
...
const Step3_CareerTerm = ({ character, setCharacter, nextStep, setWarBrokeOut }) => {
    ...
    const availableSpecialties = useMemo(() => {
        ...
        const baseList = isDuplicateSpecialty ? gameData.ALL_SPECIALTIES : (selectedCareerData?.specialties || []);
        return baseList.filter(s => {
            if (s === 'Linguist') return true;
            return !character.specialties.some(owned => owned.startsWith(s));
        });
    }, [promotionResult, isDuplicateSpecialty, selectedCareerData, character.specialties]);
